...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#339966");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#FF0000");
...
//    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3CFFFFFF");
    ...
    private void createShader() {
        ...
        Log.i("WaveView", "getWidth: " + String.valueOf(getWidth()));
        Log.i("WaveView", "getHeight: " + String.valueOf(getHeight()));
...
//            canvas.drawLine(beginX, beginY, beginX, endY, wavePaint);//这句代码的是绘制有水面的曲线
            ...
            //下面这句代码是绘制一条波浪曲线的
            canvas.drawLine(beginX, beginY, beginX, (float) ((mDefaultWaterLevel + mDefaultAmplitude * Math.sin(wx)) + 2), wavePaint);
            //(float) ((mDefaultWaterLevel + mDefaultAmplitude * Math.sin(wx))+1),最后这个加一，可以控制线条的粗细

            Log.i("WaveView", "Behind wx: " + wx);
            Log.i("WaveView", "Behind beginX: " + beginX);
            Log.i("WaveView", "Behind beginY: " + beginY);

            waveY[beginX] = beginY;
//            waveY[beginX] = (float) (mDefaultWaterLevel + mDefaultAmplitude * Math.cos(wx));
...
//            canvas.drawLine(beginX, waveY[(beginX + wave2Shift) % endX], beginX, endY, wavePaint);
            canvas.drawLine(beginX, waveY[(beginX + wave2Shift) % endX], beginX, (float) (waveY[(beginX + wave2Shift) % endX] + 2), wavePaint);


            Log.i("WaveView", "Front wave2Shift: " + wave2Shift);
            Log.i("WaveView", "Front beginX: " + beginX);
            Log.i("WaveView", "Front beginY: " + waveY[(beginX + wave2Shift) % endX]);
