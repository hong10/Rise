...
/**
 * link: http://blog.csdn.net/yan8024/article/details/42527229
 */
public class ReferencesTest {
    ...
    public void weakReference() throws InterruptedException {
        ...
        Thread.sleep(500);
        /**
         *weak reference</strong> 在 GC 后会被置成null，对象就可以被 回收了。。。
         */
    ...
    public void phantomReferenceAlwaysNull() {
        ...
        /**
         * phantom reference的 get 方法永远返回 null
         */
     ...
     * ReferenceQueue 传给一个 Reference 的构造函数， 当对象被回收时， 虚拟机会自动将这个weak</strong> ref插入到
